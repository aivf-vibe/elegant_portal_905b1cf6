...
document.querySelectorAll('.feature-card, .testimonial-card, .pricing-card, .faq-item').forEach(el => {
    observer.observe(el);
});
...
if (footerYear) {
    footerYear.innerHTML = `&copy; ${currentYear} DentalFlow. All rights reserved.`;
}
...
document.querySelectorAll('img').forEach(img => {
    if (!img.alt) {
        img.alt = 'Dental practice management';
    }
});

// Add focus trap for modal-like interactions
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DentalFlow CRM landing page initialized successfully!');
